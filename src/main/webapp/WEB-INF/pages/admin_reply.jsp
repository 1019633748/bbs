...
<body>
	...
	<div id="main-div">
		...
		<div id="right-div">
			<h3 id="title-h3" align="center">回复管理</h3>
	...
	$(document).ready(function(){
					...
					columns : [
							...
							},
							{
								...
								formatter : function(value, row, index) {
									if (row.status === 1) {
										var element = "<input class='btn btn-sm btn-danger' onclick='hideReply("
												+ row.id
												+ ","
												+ row.status
		...
		hideReply=function (id, value) {
			var handle = "show";
			if (value == 0) {
				handle = 'hide'
			}
			var url = '/bbs/' + handle + '/replys/' + id
