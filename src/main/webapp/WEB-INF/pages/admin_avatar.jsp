...
<body>
	...
	<div id="main-div">
		...
		<div id="right-div">
			<h3 id="title-h3" align="center">头像审核</h3>
		...
		$(document)
				.ready(
						function() {
												...
												columns : [
														{
															...
															formatter : function(value,row,index){
																return "<img style='width:200px;height:200px' src='/images/avatar/"+row.url+"'/>"
															}
														},
														{
															filed : "tool",
															...
															formatter : function(
																	value, row,
																	index) {
																	var element = "<input class='btn btn-sm btn-danger' onclick='hideAvatar("
																			+ row.id
							...
							//请求服务数据时所传参数
							function queryParamsAvatar(params) {
								return {
							...
							hideAvatar=function (id, value) {
								var handle = "hide";
								var url = '/bbs/' + handle + '/avatars/' + id
