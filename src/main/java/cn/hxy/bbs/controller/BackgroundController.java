...
public class BackgroundController {
	 ...
	 * 
	 * @ResponseBody public TableData<SectionSize> adminSection(int pageSize,int
	 * pageIndex,String param){ TableData<SectionSize> tableData = new
	 * TableData<SectionSize>(); PageHelper.startPage(pageIndex, pageSize);
	 ...
	 * 
	 * @ResponseBody public String hideSectionById(@PathVariable("id")int id){
	 * sectionService.hideSectionById(id,1); return null; }
	 * 
	 * @PostMapping("show/sections/{id}")
	 * 
	 * @ResponseBody public String showSectionById(@PathVariable("id")int id){
	 * sectionService.hideSectionById(id,0); return null; }
	 * 
	 * @PostMapping("verify/section/{section}")
	 * 
	 * @ResponseBody public int verifySection(@PathVariable("section")String
	 * section){ if(sectionService.getSectionByName(section)==null){ return 0; }
	 * return 1; }
	 * 
	 * @PostMapping("post/section")
	 * 
	 * @ResponseBody public void addSection(Section section){
	 ...
	 * 
	 * @ResponseBody public TableData<PostDetail> getPostdetail(int pageSize,int
	 * pageIndex,String param){ TableData<PostDetail> tableData = new
	 * TableData<PostDetail>(); PageHelper.startPage(pageIndex, pageSize);
	 * tableData.setRows(postService.findAllAdminPost());
	 * tableData.setTotal(postService.findAllAdminPost().size()); return
	 * tableData; }
	 * 
	 * 
	 * 
	 ...
	 * 
	 * @ResponseBody public String hidePostById(@PathVariable("id")int id){
	 * postService.hidePostById(id,1); return null; }
	 * 
	 * @PostMapping("show/posts/{id}")
	 * 
	 * @ResponseBody public String showPostById(@PathVariable("id")int id){
	 * postService.hidePostById(id,0); return null; }
	 */
